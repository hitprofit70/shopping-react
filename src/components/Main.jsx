    ...
    return (
            <div className='main'>
                <div className='container'>
                    <h2>Happy Wednesday, Guest</h2>
                    <span>You have 0 to spend as you choose!</span>
                    ...
                    <div className='small-card'>
                        ...
                        <div className='row'>
                            <span className='card-one'>
                                <a>Home & Garden</a></span>
                            <span className='card-one'>
                                <a>Groceries & Household</a></span>
                            <span className='card-one'>
                                <a>Greenbacks Exclusive</a></span>
                            <span className='card-one'>
                                <a>Jewellery</a></span>
                            <span className='card-one'>
                                <a>Office & Stationery</a></span>
                            <span className='card-one'><a>Deals</a></span>
                            <span className='card-one'><a>Load Shedding</a></span>
                            <span className='card-one'><a>Liqour</a></span>
                            <span className='card-one'><a>Tech</a></span>
                            <span className='card-one'><a>Fashion</a></span>
                            <span className='card-one'><a>Gaming</a></span>
                            <span className='card-one'><a>Beauty</a></span>
                            <span className='card-one'><a>DIY</a></span>
                            <span className='card-one'><a>Experince</a></span>
                            <span className='card-one'><a>Baby</a></span>
                            <span className='card-one'><a>Books</a></span>
                            <span className='card-one'><a>Bags</a></span>
                            <span className='card-one'><a>Travel</a></span>
                            <span className='card-one'><a>Sports & Hobbies</a></span>
                        </div>
                    </div>
